      ...
      <Slide accentColor="#1f2937">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
          ...
          <div className="col-span-1 md:col-span-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { n: "Z同学", d: "都柏林大学商业分析专业，现南洋理工大学硕士在读。" },
                { n: "T同学", d: "都柏林大学商业分析专业，现香港大学硕士在读。" },
                { n: "W同学", d: "GPA 3.3，录取南洋理工硕士，现获新加坡EP准证。" },
                { n: "L同学", d: "悉尼大学金融专业录取，PPAC课程期间获得全A成绩。" },
                { n: "H同学", d: "莫纳什大学录取，成功跨专业申请商业管理方向。" },
                { n: "S同学", d: "曼彻斯特大学录取，通过PPAC获得120学分豁免。" },
                { n: "K同学", d: "伦敦大学学院录取，学术写作能力在预科期间显著提升。" },
                { n: "M同学", d: "新南威尔士大学录取，现已获得澳洲名企实习机会。" }
              ].map((c, i) => (
                <motion.div 
                  key={i} 
